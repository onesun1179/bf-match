    ...
    <main style={main}>
      <section style={sec}>
        <div style={hero}>
          ...
          <p style={{ margin: "10px 0 0", color: "var(--brand)", fontSize: 12, fontWeight: 700 }}>MATCH LOG</p>
          <h1 style={{ margin: "6px 0 0", fontSize: 28, fontWeight: 600, letterSpacing: 0 }}>최근 경기</h1>
        </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
                ...
                <p style={{ margin: "3px 0 0", fontSize: 12, color: "var(--muted)" }}>
                  <Link href={`/groups/${g.groupId}`} onClick={(e) => e.stopPropagation()} style={{ color: "var(--brand)", textDecoration: "none", fontWeight: 700 }}>{g.groupName}</Link>
                </p>
