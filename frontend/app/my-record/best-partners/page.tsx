    ...
    <main style={main}>
      <section style={sec}>
        <div style={hero}>
          ...
          <p style={{ margin: "10px 0 0", color: "var(--brand)", fontSize: 12, fontWeight: 700 }}>SYNERGY</p>
          <h1 style={{ margin: "6px 0 0", fontSize: 28, fontWeight: 600, letterSpacing: 0 }}>베스트 파트너</h1>
        </div>
