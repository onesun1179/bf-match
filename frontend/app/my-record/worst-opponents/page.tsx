  ...
  return (
    <main style={main}>
      <section style={sec}>
        ...
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 800, letterSpacing: "-0.02em" }}>워스트 상대</h1>
        <p style={{ margin: 0, color: "var(--muted)", fontSize: 13 }}>이 상대를 만나면 승률이 낮습니다</p>
