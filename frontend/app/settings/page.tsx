  ...
  return (
    <main style={{ minHeight: "100vh", padding: "24px 16px 80px" }}>
      <section style={{ maxWidth: 520, margin: "0 auto", display: "grid", gap: 16 }}>
        <div style={hero}>
          <p style={{ margin: 0, color: "var(--brand)", fontWeight: 700 }}>설정</p>
          <h1 style={{ margin: "8px 0 6px", fontSize: 30, fontWeight: 600 }}>설정 항목</h1>
        ...
        <Link href="/settings/notifications" style={itemLink}>
          ...
          <span style={{ color: "var(--brand)", fontWeight: 700 }}>이동</span>
        </Link>
